							...
							<div class="card wizard-card" data-color="orange" id="wizard">
								...
								<div class="tab-content">
									...
									<div class="tab-pane" id="colorbyhuman">
										...
										<form action="cctvv" method="post">
											<div class="row">
												<div class="col-sm-4">
													<div class="choice" data-toggle="wizard-checkbox"
														onclick="colorPicker()">
														<input type="checkbox" name="human" value="topColor">
												...
												<div class="col-sm-4">
													<div class="choice" data-toggle="wizard-checkbox">
														<input type="checkbox" name="human" value="bottomColor">
														<div class="card card-checkboxes card-hover-effect">
															<i class="ti-control-record"></i>
															<p>bottom</p>
														</div>
												...
												<div class="col-sm-4">
													<div class="choice" data-toggle="wizard-checkbox">
														<input type="checkbox" name="human" value="onepeiceColor">
														<div class="card card-checkboxes card-hover-effect">
															<i class="ti-control-record"></i>
															<p>one-piece</p>
														</div>
									...
									<div class="tab-pane" id="colorbything">
										...
										<form action="cctv" method="post">
											<div class="row">
												<div class="col-sm-4">
													<div class="choice" data-toggle="wizard-checkbox">
														<input type="checkbox" name="thing" value="walletColor">
														<div class="card card-checkboxes card-hover-effect">
															<i class="ti-control-record"></i>
															<p>wallet</p>
														</div>
												...
												<div class="col-sm-4">
													<div class="choice" data-toggle="wizard-checkbox">
														<input type="checkbox" name="thing" value="backpackColor">
														<div class="card card-checkboxes card-hover-effect">
															<i class="ti-control-record"></i>
															<p>backpack</p>
														</div>
												...
												<div class="col-sm-4">
													<div class="choice" data-toggle="wizard-checkbox">
														<input type="checkbox" name="thing" value="phoneColor"
									...
									<div class="tab-pane" id="colorbydog">
										...
										<form action="cctv" method="post">
											<div class="row">
												<div class="col">
													<div class="choice" data-toggle="wizard-checkbox">
														<input type="checkbox" name="dog" value="dogColor">
														<div class="card card-checkboxes card-hover-effect">
															<i class="ti-control-record"></i>
															<p>color</p>
														</div>

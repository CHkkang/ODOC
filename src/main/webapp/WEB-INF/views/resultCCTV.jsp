...
<script type="text/javascript">
   ...
   window.onload = function() {
	  ...
	  firstMarker(aVideo, bVideo, cVideo, dVideo, video1, video2, video3, video4, localPath);
      videoChange(aVideo, bVideo, cVideo, dVideo, "new"+video1, "new"+video2, "new"+video3, "new"+video4, localPath);
   ...
   <div class="video-container" id="video1">
      <div style="float: left; width: 50%;">
         <video id="a" controls class="video-js"
            data-setup='{"fluid": true, "autoplay" : true, "muted" : true}' src="${pageContext.request.contextPath}/resources/video/aaCCTV1.mp4">
         </video>
      </div>
      <div style="float: left; width: 50%">
         <video id="b" controls class="video-js"
            data-setup='{"fluid": true, "autoplay" : true, "muted" : true}' src="${pageContext.request.contextPath}/resources/video/bbCCTV1.mp4">
         </video>
      </div>
   </div>
   <div class="video-container" id="video1">
      <div style="float: left; width: 50%;">
         <video id="c" controls class="video-js"
            data-setup='{"fluid": true, "autoplay" : true, "muted" : true}' src="${pageContext.request.contextPath}/resources/video/ccCCTV1.mp4">
         </video>
      </div>
      <div style="float: left; width: 50%">
         <video id="d" controls class="video-js"
            data-setup='{"fluid": true, "autoplay" : true, "muted" : true}' src="${pageContext.request.contextPath}/resources/video/ddCCTV1.mp4">
         </video>
      </div>
   </div>
   <!-- 영상 처리 부분 끝-->

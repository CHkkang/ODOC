...
<script
   src='${pageContext.request.contextPath}/resources/videojs.markers.js'></script>
>>>>>>> 981ae1140ad71c0e9cbc6f928241f0b1cc501040
 -->
...
<<<<<<< HEAD
	data-offset="300" style="background-color: rgba(0, 0, 0, 0.5); padding-right: 0px">
	<div class="site-wrap">
		<!-- 네비게이션 바 (팝업 호출 용) -->
	...
	<div class="video-container" id="video1">
		...
		<div style="float:left; width:50%;">
			<video id="demo" controls class="video-js" data-setup='{"fluid": true}'>	

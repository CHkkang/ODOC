...
<script type="text/javascript">
   ...
   function colorpicker(){
	   ...
	   var cp = document.getElementById('llo');
	   console.log(cp)
				...
				<div class="d-flex align-items-center">
					<div class="site-logo">
						<a href="" data-toggle="modal" data-target="#myCenterModal"
							style="margin-top: 2px; text-align: center; display: inline-block;">
													...
													<div class="row">
														...
														<div class="col-xs-6 col-sm-2">
															<div class="choice" data-toggle="wizard-checkbox"
																...
																onclick="isChecked(this.id); colorpicker();">
																<input type="checkbox" name="topKind" value="longTopC"
																	id="longTopC">
																<div class="icon">
																	<i class="material-icons">panorama_fish_eye</i>
																	<div id = "llo"class="container2" style="display:none">
													...
													<div class="row">
														...
														<div class="col-xs-6 col-sm-2">
															<div class="choice" data-toggle="wizard-checkbox"
																...
																onclick="isChecked(this.id)">
																<input type="checkbox" name="topOnepieceKind"
														...
														<div class="col-xs-6 col-sm-2">
															<div class="choice" data-toggle="wizard-checkbox"
																...
																onclick="isChecked(this.id)">
																<input type="checkbox" name="bottomOnepieceKind"
																	value="longBottomOnePieceC" id="longBottomOnePieceC">
																<div class="icon">
																	<i class="material-icons">panorama_fish_eye</i>
																</div>
																<h6>한벌 긴바지</h6>
														...
														<div class="col-xs-6 col-sm-2">
															<div class="choice" data-toggle="wizard-checkbox"
																...
																onclick="isChecked(this.id)">
																<input type="checkbox" name="bottomOnepieceKind"
																	value="shortBottomOnePieceC" id="shortBottomOnePieceC">
																<div class="icon">
																	<i class="material-icons">panorama_fish_eye</i>
																</div>
																<h6>한벌 반바지</h6>

      ...
      if (c == "choice") {
         if( inputid.includes("OnePiece")){
            if( inputid.includes("Top")){
               ...
               id = inputid.includes("short")?"longTopOnePiece":"shortTopOnePiece";
            ...
            if( inputid.includes("Bottom")){
               ...
               id = inputid.includes("short")?"longBottomOnePiece":"shortBottomOnePiece";
               $("#"+id).attr("class", "choice");
            ...
            if( inputid.includes("Bottom")){
               ...
               id = inputid.includes("short")?"longBottom":"shortBottom";
               $("#"+id).attr("class", "choice");
                                       ...
                                       <div class="row">
                                          ...
                                          <div class="col-xs-6 col-sm-2">
                                             <div class="choice" data-toggle="wizard-checkbox"
                                                ...
                                                <input type="checkbox" name="topKind" value="longTopC" id="longTopC">
                                                <div class="icon">
                                          ...
                                          <div class="col-xs-6 col-sm-2">
                                             <div class="choice" data-toggle="wizard-checkbox"
                                                ...
                                                onclick="isChecked(this.id)">
                                                <input type="checkbox" name="topKind" value="shortTopC" id="shortTopC">
                                                <div class="icon">
                                                   <i class="material-icons">panorama_fish_eye</i>
                                                </div>
                                                <h6>반팔</h6>
                                          ...
                                          <div class="col-xs-6 col-sm-2">
                                             <div class="choice" data-toggle="wizard-checkbox"
                                                ...
                                                onclick="isChecked(this.id)">
                                                <input type="checkbox" name="bottomKind" value="longBottomC" id="longBottomC">
                                                <div class="icon">
                                                   <i class="material-icons">panorama_fish_eye</i>
                                                </div>
                                                <h6>긴바지</h6>
                                          ...
                                          <div class="col-xs-6 col-sm-2">
                                             <div class="choice " data-toggle="wizard-checkbox"
                                                ...
                                                onclick="isChecked(this.id)">
                                                <input type="checkbox" name="bottomKind" value="shortBottomC" id="shortBottomC">
                                                <div class="icon">
                                                   <i class="material-icons">panorama_fish_eye</i>
                                                </div>
                                                <h6>반바지</h6>
                                       ...
                                       <div class="row">
                                          ...
                                          <div class="col-xs-6 col-sm-2">
                                             <div class="choice" data-toggle="wizard-checkbox"
                                                ...
                                                onclick="isChecked(this.id)">
                                                <input type="checkbox" name="topOnepieceKind" value="longTopOnePieceC" id="longTopOnePieceC">
                                                <div class="icon">
                                                   <i class="material-icons">panorama_fish_eye</i>
                                                </div>
                                                <h6>한벌 긴팔</h6>
                                          ...
                                          <div class="col-xs-6 col-sm-2">
                                             <div class="choice" data-toggle="wizard-checkbox"
                                                ...
                                                onclick="isChecked(this.id)">
                                                <input type="checkbox" name="topOnepieceKind" value="shortTopOnePieceC" id="shortTopOnePieceC">
                                                <div class="icon">
                                                   <i class="material-icons">panorama_fish_eye</i>
                                                </div>
                                                <h6>한벌 반팔</h6>
                                          ...
                                          <div class="col-xs-6 col-sm-2">
                                             <div class="choice" data-toggle="wizard-checkbox"
                                                rel="tooltip" title="Top" id="longBottomOnePiece"
                                                onclick="isChecked(this.id)">
                                                <input type="checkbox" name="bottomOnepieceKind" value="longBottomOnePieceC" id="longBottomOnePieceC">
                                                <div class="icon">
                                                   <i class="material-icons">panorama_fish_eye</i>
                                                </div>
                                                <h6>한벌 긴바지</h6>
                                          ...
                                          <div class="col-xs-6 col-sm-2">
                                             <div class="choice" data-toggle="wizard-checkbox"
                                                rel="tooltip" title="Top" id="shortBottomOnePiece"
                                                onclick="isChecked(this.id)">
                                                <input type="checkbox" name="bottomOnepieceKind" value="shortBottomOnePieceC" id="shortBottomOnePieceC">
                                                <div class="icon">
                                                   <i class="material-icons">panorama_fish_eye</i>
                                                </div>
                                                <h6>한벌 반바지</h6>
   ...
   <!-- colorpicker 구상 
	 <div class="container">
	  <div class="color-picker block-center">
	    ...
	    <form>
	      <input type="text" class="form-control"           id="setColor"/>
	    </form>
	    </div>
	  </div>
  -->
